<div class="card callout callout-success puja-card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <p class="col-md-8 " style="font-weight:bold">{{ $puja->name }}</p>


            <p class="col-md-4">Home Amount: </p>
            <p class="col-md-8 " style="font-weight:bold"> {{ formatAmount($puja->home_amount) }}</p>



            <h6 class="col-md-4">Total Amount:</h6>
            <h6 class="col-md-8 " style="font-weight:bold; color:#980406"> {{ formatAmount($puja->temple_amount) }}</h6>
