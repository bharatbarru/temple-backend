        ...
        <div class="card rounded-0 bg-tertiary  p-5">
            <div class="row  justify-content-between position-relative">
                <div class="col-md-6 block text-light">
                    <img src="{{ asset('assets/1.svg') }}" class="queries-img" alt="queries img" data-aos="zoom-in"/>
                    <div class="inner">
                        ...
                        <a class="d-block" href="tel:{!! applicationSettings('primary-phone-number') !!}">{!! applicationSettings('primary-phone-number') !!}</a>
                        <a class="d-block" href="tel:{!! applicationSettings('primary-phone-number') !!}">{!! applicationSettings('primary-email') !!}</a>
                    </div>
                </div>
