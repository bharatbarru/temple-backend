                        ...
                        <div class="col-md-6 col-lg-4 d-flex ">
                            <div class="card">
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="{{ url('blog/' . $blogPost->slug) }}">
                                        <h4 class="font-color">{{ $blogPost->title }}</h4>
                                    </a>
                                    <figure class="m-0"> <img src="{{ asset(BLOG_POST_IMAGE_PATH . $blogPost->author_image) }}" alt="Image"
                                        class="card-img-top"></figure>
                                    <p class="flex-grow-1">
                                        {!! \Illuminate\Support\Str::limit(strip_tags($blogPost->description), 150, '...') !!}
                                    </p>
                                <a href="{{ url('blog/' . $blogPost->slug) }}" class="lead hover-arrow mt-5 d-inline-block">Read More</a>
                                </div>
                            </div>
                        </div>
                    @endforeach
