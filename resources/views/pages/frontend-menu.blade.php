...
<div class="navbar-container ">
    <nav class="navbar navbar-expand-lg  navbar-light">
      <div class="container">
        <a class="navbar-brand fade-page hide-991" href="{{ url('/') }}">
            <img class="main-logo logo-dark logo-default" alt="{{ applicationSettingsAltText('logo') }}"
        ...
        <div class="collapse navbar-collapse justify-content-end">
          <div class="py-2 py-lg-0">
            <ul class="navbar-nav">
                ...
                <li
                    ...
                    <a href="{{ pageLink($menu->type, $menu->slug, $menu->custom_url) }}"
                        ...
                        @if ($menu->custom_url) target="_blank" @endif>
                        {{ $menu->title }}
                                ...
                                <div class="dropdown-grid-menu">
                                    @foreach ($menu->subMenu as $subMenu)
                                        <a href="{{ pageLink($subMenu->type, $subMenu->slug, $subMenu->custom_url) }}"
                                            ...
                                            @if ($subMenu->custom_url) target="_blank" @endif>
            ...
            <!-- Cart Icon -->
            <li class="nav-item">
                <a href="{{ url('/cart') }}" class="nav-link cart-icon position-relative">
            ...
            <li class="nav-item dropdown">
                ...
                @else
                    <a href="{{ url('/user-login') }}" class="nav-link btn btn-tertiary">Login</a>
                @endif
            </li>
            </ul>
          </div>
