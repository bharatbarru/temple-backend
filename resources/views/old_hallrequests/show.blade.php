  ...
  <div class="card callout-success-bg puja-card">
    ...
    <div class="card-body">
        <div class="row">
            ...
            <h5 class="col-md-8 text-primary" style="font-weight:bold">{{ $order->hall_request_id }}</h5>
        </div>
        ...
        <div class="card-body"> 
            <div class="row">
                ...
                @if($order->request_status == "PENDING")
                    ...
                    <p class="col-md-8 font-weight-bold">{{ formatDate($order->alternate_date_of_event) }}</p>
                @endif
        ...
        <div class="card-body">
            <div class="row">
                ...
                <p class="col-md-4">
                    ...
                    <span style="color: #cc0000">{{ $order->package_name }}</span>
                </p>
                <p class="col-md-8 font-weight-bold">{{ formatAmount($order->total_amount) }}</p>
