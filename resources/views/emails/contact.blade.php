                        ...
                        <td style="padding: 20px;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" width="100%" style="margin-top: 20px;">
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; padding: 10px; border-bottom: 1px solid #ddd;">{{ $request->name }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; padding: 10px; border-bottom: 1px solid #ddd;">{{ $request->email }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; padding: 10px; border-bottom: 1px solid #ddd;">{{ $request->phone }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; padding: 10px; border-bottom: 1px solid #ddd; font-weight: bold">{{ $request->message }}</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
