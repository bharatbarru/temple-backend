    ...
    <div class="card">
        <div class="card-body">
            ...
            <li class="nav-item"> <a href="{{ url('admin/settings?type=home-page-blocks') }}"
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/settings?type=custom-blocks') }}" class="nav-link {{ request()->input("type") == "custom-blocks" ? "active" : "" }}">
            ...
            <li class="nav-item"> <a href="{{ url('admin/settings?type=template-settings') }}"
                ...
                <li class="nav-item">
                    <a href="{{ url('admin/style-guide') }}" class="nav-link {{ request()->is('admin/style-guide*') ? 'active' : '' }}">
                        <i class="nav-icon fas fa-cogs"></i>
                        <p>Style Guide</p>
                    </a>
                </li>
