                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600" align="center" style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0,0,0,0.1); border-top: solid 10px #ea2735;">
                    ...
                    <tr>
                        <td style="text-align: center; padding: 20px;">
                            <h1 style="font-family: Arial, sans-serif; font-size: 24px; color: #333333;">Hello <?php echo e($order->customer ? $order->customer->name : $order->guest_name); ?></h1>
                            <p style="font-family: Arial, sans-serif; font-size: 18px; color: #333333; margin: 0; padding: 0;">Your order <b>Order Id : <?php echo e($order->orderid); ?></b> has been declined.</p>
                            <p style="font-family: Arial, sans-serif; font-size: 18px; color: #333333; margin: 0; padding: 0;">Reason: <?php echo e($order->reason_for_cancellation); ?></p>
                        </td>
                    </tr>
                    <tr>
...
</html><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\emails\user-order-declined.blade.php ENDPATH**/ ?>