...
<div class="container-fluid p-5">
    ...
    <?php if(getLoggedInUserRole() == 'super admin' || getLoggedInUserRole() == 'Developer Admin'): ?>
        <div class="row">
                    ...
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                                View
                                <!-- <i>(30)</i>  -->
                                <a href="<?php echo e(route('pujaOrders.index')); ?>" class="float-right">
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card card-primary card-outline admin-card">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered ">
                            <li class="list-group-item">
                            View <a href="<?php echo e(route('hallOrders.index')); ?>" class="float-right">
                                    <span class="material-symbols-outlined">
                                        east
                                    </span>
                                </a>
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="card card-primary card-outline admin-card">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered">
                            <li class="list-group-item">
                            View <a href="<?php echo e(route('templeTours.index')); ?>" class="float-right">
                                    <span class="material-symbols-outlined">
                                        east
                                    </span>
                                </a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\DELL\Desktop\laravel-backup-20260801\laravel\resources\views/home.blade.php ENDPATH**/ ?>