            ...
            <div class="card no-mob-card">
                <div class="card-body">
                    <div class="text-center">
                        <h2 class="card-title h2">Thank you for your order, <?php echo e($order->customer ? $order->customer->name : $order->guest_name); ?>!</h2>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\pages\orders\confirmation.blade.php ENDPATH**/ ?>