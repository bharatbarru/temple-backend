        ...
        <div class="container">
            ...
            <?php if($blogPosts->count() > 0): ?>
                        ...
                        <div class="col-md-6 col-lg-4 d-flex ">
                            <div class="card">
                                <a href="<?php echo e(url('blog/' . $blogPost->slug)); ?>">
                                    <figure class="m-0"> <img src="<?php echo e(asset(BLOG_POST_IMAGE_PATH . $blogPost->image)); ?>" alt="Image"
                                ...
                                <div class="card-body d-flex flex-column">
                                    ...
                                    <a href="<?php echo e(url('blog/' . $blogPost->slug)); ?>">
                                        <h4 class="font-color"><?php echo e($blogPost->title); ?></h4>
                                    </a>
                                    <figure class="m-0"> <img src="<?php echo e(asset(BLOG_POST_IMAGE_PATH . $blogPost->author_image)); ?>" alt="Image"
                                        class="card-img-top"></figure>
                                    <p class="flex-grow-1">
                                        <?php echo \Illuminate\Support\Str::limit(strip_tags($blogPost->description), 150, '...'); ?>

                                    </p>
                                <a href="<?php echo e(url('blog/' . $blogPost->slug)); ?>" class="lead hover-arrow mt-5 d-inline-block">Read More</a>
                                </div>
                            </div>
                        </div>
                ...
                <ul class="pagination pagination-lg justify-content-center">
                    <?php echo e($blogPosts->appends(request()->query())->links()); ?>
...
<?php echo $__env->make('frontend.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\pages\blog.blade.php ENDPATH**/ ?>