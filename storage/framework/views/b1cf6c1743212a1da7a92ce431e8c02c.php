            ...
            <div class="row align-items-center justify-content-between">
                <div class="col-md-5 block text-light">
                    <div class="inner">
                        ...
                        <a class="d-block" href="tel:<?php echo applicationSettings('primary-phone-number'); ?>"><i class="flaticon-telephone"></i> <?php echo applicationSettings('primary-phone-number'); ?></a>
                        <a class="d-block" href="mailto:<?php echo applicationSettings('primary-email'); ?>"><i class="flaticon-email-1"></i> <?php echo applicationSettings('primary-email'); ?></a>
                    </div>
                </div>
                <div class="col-md-7 form">
                    <div class="card card-body text-dark">
                        ...
                        <form action="<?php echo e(url('booking-form-submission')); ?>" method="POST" id="booking-form">
...
<?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\pages\book-table.blade.php ENDPATH**/ ?>