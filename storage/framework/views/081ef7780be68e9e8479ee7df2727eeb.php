...
<div class="container-fluid px-2">
     ...
     <div class="row mb-4 p-2">
        ...
        <div class="form-group col-md-6">
            <?php echo Form::label('type_of_event', 'Type Of Event:'); ?>

            <div class="radio-block ">
                <label class="px-2"><?php echo Form::radio('type_of_event', 'personal', null, ['required']); ?> <span>Personal</span></label>
                <label class="px-2"><?php echo Form::radio('type_of_event', 'community', null, ['required']); ?> <span>Community</span></label>
                <label class="px-2"><?php echo Form::radio('type_of_event', 'hindu_temple', null, ['required']); ?> <span>For Hindu Temple</span></label>
            </div>
        </div>
        <div class="form-group col-md-6">
            <?php echo Form::label('event_duration', 'Event Type:'); ?>

            <div class="radio-block">
                <label class="px-2"><?php echo Form::radio('event_duration', 'one-day'); ?> <span>One Day</span></label>
                <label class="px-2"><?php echo Form::radio('event_duration', 'multiple-days'); ?> <span>Multiple Days</span></label>
            </div>
        </div>
        <div class="form-group col-md-6">
            <?php echo Form::label('date_of_event', 'Date Of the Event:'); ?>

            <?php echo Form::text('date_of_event', null, ['class' => 'form-control dateonlypicker', 'required','id'=>'date_of_event']); ?>

        </div>
        <div class="form-group col-md-6" id="end_date_container" style="display: none;">
            <?php echo Form::label('end_date_of_event', 'End Date Of the Event:'); ?>

            <?php echo Form::text('end_date_of_event', null, ['class' => 'form-control  dateonlypicker', 'id'=>'end_date_of_event']); ?>

        </div>
        

        <div class="form-group col-md-6">
            <?php echo Form::label('hall_event_type_id','Hall Event Type:'); ?>

            <?php echo Form::select('hall_event_type_id', $hallEventTypes, null, ['class' => 'form-control select2', 'id' => 'hall_event_type_id', 'placeholder' => 'Select Event']); ?>
    ...
    <div id="hall_booking_details_content" style="display: none;">
        ...
        <div class="row mb-4 px-2 ">
            ...
            <div class="col-12">
                <div class="hall-selection-container">
                    <div class="row">
                        <?php $__currentLoopData = $hallsWithAddonsAndCosts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $hall): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="col-md-12 col-lg-12 mb-4">
                            <div class="hall-item card shadow-sm"
                                 data-monday-cost="<?php echo e($hall['monday_cost']); ?>"
                                 data-tuesday-cost="<?php echo e($hall['tuesday_cost']); ?>"
                                 data-wednesday-cost="<?php echo e($hall['wednesday_cost']); ?>"
                                 data-thursday-cost="<?php echo e($hall['thursday_cost']); ?>"
                                 data-friday-cost="<?php echo e($hall['friday_cost']); ?>"
                                 data-saturday-cost="<?php echo e($hall['saturday_cost']); ?>"
                                 data-sunday-cost="<?php echo e($hall['sunday_cost']); ?>"
                                 data-monday-three-day-cost="<?php echo e($hall['monday_three_day_cost']); ?>"
                                 data-tuesday-three-day-cost="<?php echo e($hall['tuesday_three_day_cost']); ?>"
                                 data-wednesday-three-day-cost="<?php echo e($hall['wednesday_three_day_cost']); ?>"
                                 data-thursday-three-day-cost="<?php echo e($hall['thursday_three_day_cost']); ?>"
                                 data-friday-three-day-cost="<?php echo e($hall['friday_three_day_cost']); ?>"
                                 data-saturday-three-day-cost="<?php echo e($hall['saturday_three_day_cost']); ?>"
                                 data-sunday-three-day-cost="<?php echo e($hall['sunday_three_day_cost']); ?>"
                                 data-hall-id="<?php echo e($hall['id']); ?>">
                                <div class="card-body">
                                    <div class="form-check mb-3">
                                        <input type="checkbox" class="form-check-input main-hall-checkbox" 
                                               id="hall_<?php echo e($hall['id']); ?>" 
                                               name="selected_halls[]" 
                                               value="<?php echo e($hall['id']); ?>"
                                               data-hall-id="<?php echo e($hall['id']); ?>">
                                        <label class="form-check-label h5 mb-0 d-flex justify-content-between w-100" for="hall_<?php echo e($hall['id']); ?>">
                                            <span><?php echo e($hall['name']); ?></span>
                                            <span class="text-muted small" id="hall_display_cost_<?php echo e($hall['id']); ?>"></span>
                                        </label>
                                        <!-- Add hidden input for hall cost -->
                                        <input type="hidden" name="hall_costs[<?php echo e($hall['id']); ?>]" id="hall_cost_<?php echo e($hall['id']); ?>" value="0">
                                    </div>
                                    
                                    <!-- Addons for this hall -->
                                    <div class="hall-addons border-top pt-3" id="addons_<?php echo e($hall['id']); ?>" style="display: none;">
                                            ...
                                            <?php $__currentLoopData = $hall['addons']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $addon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <div class="form-check mb-2">
                                                    <input type="checkbox" class="form-check-input hall-addon-checkbox" 
                                                           id="addon_<?php echo e($addon['id']); ?>" 
                                                           name="selected_addons[<?php echo e($hall['id']); ?>][]" 
                                                           value="<?php echo e($addon['id']); ?>"
                                                           data-addon-id="<?php echo e($addon['id']); ?>"
                                                           data-hall-id="<?php echo e($hall['id']); ?>"
                                                           data-monday-cost="<?php echo e($addon['monday_cost']); ?>"
                                                           data-tuesday-cost="<?php echo e($addon['tuesday_cost']); ?>"
                                                           data-wednesday-cost="<?php echo e($addon['wednesday_cost']); ?>"
                                                           data-thursday-cost="<?php echo e($addon['thursday_cost']); ?>"
                                                           data-friday-cost="<?php echo e($addon['friday_cost']); ?>"
                                                           data-saturday-cost="<?php echo e($addon['saturday_cost']); ?>"
                                                           data-sunday-cost="<?php echo e($addon['sunday_cost']); ?>">
                                                    <label class="form-check-label d-flex justify-content-between w-100" for="addon_<?php echo e($addon['id']); ?>">
                                                        ...
                                                        <span class="addon-display-cost" id="addon_display_cost_<?php echo e($addon['id']); ?>" style="color: black; font-weight: bold;"></span>
                                                    </label>
                                                    <!-- Add hidden input for addon cost -->
                                                    <input type="hidden" name="addon_costs[<?php echo e($hall['id']); ?>][<?php echo e($addon['id']); ?>]" id="addon_cost_<?php echo e($addon['id']); ?>" value="0">
                                                    <?php if(stripos($addon['name'], 'pre-event prep time') !== false): ?>
                                                    <div class="prep-time-hours mt-2" style="display: none;">
                                                        ...
                                                        <div class="input-group input-group-sm" style="width: 150px;">
                                                            ...
                                                            <input type="number" class="form-control form-control-sm prep-time-select text-center" 
                                                                   name="prep_time_hours[<?php echo e($addon['id']); ?>]"
                                                                   data-addon-id="<?php echo e($addon['id']); ?>"
                                                                   value="1" min="1" max="6">
     ...
     <div class="row mb-4">
        ...
        <div class="form-group col-md-6">
            <?php echo Form::label('alternate_date_of_event', 'Alternate Date Of Event:'); ?>

            <?php echo Form::text('alternate_date_of_event', null, ['class' => 'form-control dateonlypicker','id'=>'alternate_date_of_event']); ?>
        ...
        <div class="form-group col-md-6">
            <div class="d-flex flex-column">
                ...
                <?php echo Form::select('start_time', [
                    '05:00' => '5:00 AM',
                    '06:00' => '6:00 AM',
                    '07:00' => '7:00 AM',
                    '08:00' => '8:00 AM',
    ...
    <div class="row">
        ...
        <div class="form-group col-sm-4">
            <?php echo Form::label('community_name', 'Community Name:'); ?>

            <?php echo Form::text('community_name', null, ['class' => 'form-control', 'maxlength' => 255, 'id' => 'community_name_field']); ?>
        ...
        <div class="form-group col-sm-4">
            ...
            <?php echo Form::text('last_name', null, ['class' => 'form-control', 'maxlength' => 255, 'id' => 'last_name_field']); ?>
        ...
        <div class="form-group col-sm-4">
            ...
            <?php echo Form::text('mobile', null, ['class' => 'form-control digits-input', 'required', 'maxlength' => 255]); ?>
...
<?php $__env->stopPush(); ?><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\hall_orders\fields.blade.php ENDPATH**/ ?>