...
<!-- Sub Title Field -->
<div class="form-group col-sm-4">
    <?php echo Form::label('sub_title', 'Details Title:'); ?>
...
<div class="form-group col-sm-4">
    <div class="form-check">
        ...
        <?php echo Form::label('special_product', 'Special Product', ['class' => 'form-check-label']); ?>
...
<?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\products\fields.blade.php ENDPATH**/ ?>