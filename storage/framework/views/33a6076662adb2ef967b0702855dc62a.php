...
<div class="form-group col-sm-4">
    ...
    <?php echo Form::text('coupon_code', null, ['class' => 'form-control', 'required', 'maxlength' => 255]); ?>

</div>

<!-- Image Field -->
<?php echo $__env->make('common.image.single-image', ['field_label' => 'Image', 'field_name' => 'image', 'data' => isset($coupon) ? $coupon->image : null, 'path' => COUPON_IMAGE_PATH], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<div class="form-group col-sm-4">
    ...
    <div>
        <label>
            <?php echo Form::radio('discount_type', 'fixed', isset($coupon) && $coupon->discount_type == 'fixed', ['id' => 'discount_type_fixed', 'required']); ?> Fixed
        </label>
        <label style="margin-left: 10px;">
            <?php echo Form::radio('discount_type', 'percentage', isset($coupon) && $coupon->discount_type == 'percentage', ['id' => 'discount_type_percentage']); ?> Percentage
        </label>
    </div>
</div>
...
<div class="form-group col-sm-4" id="percentage_type_field" style="display: none;">
    <?php echo Form::label('percentage_type', 'Percentage Type:'); ?>

    <div>
        <label>
            <?php echo Form::radio('percentage_type', 'flat', false, ['id' => 'percentage_type_flat']); ?> Flat
        </label>
        <label style="margin-left: 10px;">
            <?php echo Form::radio('percentage_type', 'upto', false, ['id' => 'percentage_type_upto']); ?> Upto
        </label>
    </div>
</div>
...
<div class="form-group col-sm-4" id="max_amount_field" style="display: none;">
    <?php echo Form::label('max_amount', 'Max Amount:'); ?>

    <?php echo Form::text('max_amount', isset($coupon) ? $coupon->max_amount : null, ['class' => 'form-control digits-input', 'id' => 'max_amount']); ?>

</div>

<!-- Discount Value Field (Enter Amount or Percentage) -->
<div class="form-group col-sm-4" id="discount_value_field" style="display: none;">
    <?php echo Form::label('discount_value_label', 'Enter Amount:', ['id' => 'discount_value_label']); ?>

    <?php echo Form::text('discount_value', null, ['class' => 'form-control digits-input', 'required']); ?>

</div>

<!-- Min Order Amount Field -->
<div class="form-group col-sm-4">
    <?php echo Form::label('min_order_amount', 'Min Order Amount:'); ?>

    <?php echo Form::text('min_order_amount', null, ['class' => 'form-control digits-input', 'required', 'required']); ?>
...
<div class="form-group col-sm-4">
    ...
    <?php echo Form::text('valid_from', isset($coupon) ? formatDate($coupon->valid_from) : null, ['class' => 'form-control dateonlypicker','id'=>'valid_from', 'required']); ?>

</div>

<!-- Valid Until Field -->
<div class="form-group col-sm-4">
    <?php echo Form::label('valid_until', 'Valid Until:'); ?>

    <?php echo Form::text('valid_until', isset($coupon) ? formatDate($coupon->valid_until) : null, ['class' => 'form-control dateonlypicker','id'=>'valid_until', 'required']); ?>

</div>

<!-- Usage Limit Field -->
<div class="form-group col-sm-4">
    <?php echo Form::label('usage_limit', 'Usage Limit:'); ?>

    <?php echo Form::text('usage_limit', null, ['class' => 'form-control digits-input', 'required']); ?>
...
<?php $__env->startPush('page_scripts'); ?>
    <script>
        ...
        $(document).ready(function() {
            ...
            let isEditMode = <?php echo isset($coupon) ? 'true' : 'false'; ?>;
            let maxAmount = <?php echo isset($coupon) && $coupon->max_amount ? 'true' : 'false'; ?>;
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\coupons\fields.blade.php ENDPATH**/ ?>