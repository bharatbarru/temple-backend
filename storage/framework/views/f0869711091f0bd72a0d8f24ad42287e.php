        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-search-inline column-settings-inline pb-3">
                    <form class="form-inline form-search" method="GET" action="<?php echo e(route('old.puja.requests')); ?>" autocomplete="off">
                        <div class="row text-left" style="flex-wrap: nowrap;">
                            ...
                            <div class="col-4">
                                ...
                                <a href="<?php echo e(route('old.puja.requests')); ?>" class="btn btn-info mb-2">Reset</a>
                            </div>
                        </div>
                    </form>
                    <div class="clear"></div>
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php echo e(getClassNameFromStatus($order->request_status)); ?>">
                                <td><a href="<?php echo e(route('old.puja.requests.show', $order->order_id)); ?>"><?php echo e($order->puja_request_id); ?></a></td>
                                <td><?php echo e($order->payment_status); ?></td>
                                <td><?php echo e(formatDate($order->order_date)); ?></td>
                                <td>
                                    <?php echo e(formatDate($order->date_of_puja)); ?><br>
                                    <?php echo e($order->from_time_of_puja); ?> - <?php echo e($order->to_time_of_puja); ?>

                                </td>
                                <td><?php echo e($order->puja_names ?? 'N/A'); ?></td>
                                <td><?php echo e($order->first_name . ' ' . $order->last_name); ?></td>
                                <td>
                                    <?php echo e($order->email); ?><br>
                                    <?php echo e($order->contact_no); ?>

                                </td>
                                <td><?php echo e($order->request_status == 'PENDING' ? NEW_REQUEST : $order->request_status); ?></td>
                                <td>
                                    <a href="<?php echo e(route('old.puja.requests.show', $order->order_id)); ?>" class="btn btn-default btn-xs" contenteditable="false" style="cursor: pointer;">
                                        <i class="fa fa-eye"></i>
                                    </a>
                                </td>
                            </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\old-puja-requests\index.blade.php ENDPATH**/ ?>