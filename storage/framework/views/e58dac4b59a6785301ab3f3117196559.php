...
} elseif ($_instance->childHasBeenRendered('rlahQ2o')) {
    $componentId = $_instance->getRenderedChildComponentId('rlahQ2o');
    $componentTag = $_instance->getRenderedChildComponentTagName('rlahQ2o');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('rlahQ2o');
} else {
    $response = \Livewire\Livewire::mount('puja-orders-table', []);
    $html = $response->html();
    $_instance->logRenderedChild('rlahQ2o', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
            </div>
