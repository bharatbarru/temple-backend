                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600" align="center"
                    ...
                    <tr>
                        <td style="text-align: center; padding: 20px;">
                            <h1 style="font-family: Arial, sans-serif; font-size: 24px; color: #980406;">Hall Cancel Request Recieved</h1>
                            <p
                                style="font-family: Arial, sans-serif; font-size: 13px; line-height: 20px; color: #000000;">
                                Dear Admin,
                                A Hall Cancel Request Has been Recieved
                        ...
                        <td style="padding: 0 20px 20px 20px; ">
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" borderColor="#eeeeee" width="100%"
                                ...
                                <!-- <tr bgColor="#f1f1f1">
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->event_duration == 'three-day' ? '3' : '1'); ?> Day Event
                                    </td>
                                </tr> -->
                            </table>
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" borderColor="#eeeeee" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e(formatDate($hallOrder->date_of_event)); ?></td>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->duration); ?> Hours</td>
                                        <span style="color:#980406; font-weight: bold; display: block;"></span>
                                </tr>
                                <tr bgColor="#f1f1f1">
                                    <td
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->cancelled_comments); ?></td>
                                        <span style="color:#980406; font-weight: bold; display: block;"></span>
                                </tr>
                            </table>
...
</html><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\emails\admin_hall_cancel.blade.php ENDPATH**/ ?>