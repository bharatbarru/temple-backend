<?php $__env->startSection('content'); ?>
    ...
    <div class="content px-3">
        ...
        <div class="card">
            ...
            <?php echo Form::model($news, ['route' => ['news.update', $news->id], 'method' => 'patch', 'files' => true]); ?>


            <div class="card-body">
                <div class="row">
                    <?php echo $__env->make('news.fields', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
