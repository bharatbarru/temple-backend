...
<!-- Service Type Field -->
<div class="form-group col-sm-4">
    <?php echo Form::label('service_type_id', 'Service Type'); ?>

    <?php echo Form::select('service_type_id', $type, null, [
...
<?php echo $__env->make('common.editor', ['variable' => 'editor5', 'field' => 'description'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\service_categories\fields.blade.php ENDPATH**/ ?>