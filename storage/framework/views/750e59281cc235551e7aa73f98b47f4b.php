                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600" align="center" style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0,0,0,0.1); border-top: solid 10px #ea2735;">
                    ...
                    <tr>
                        <td style="text-align: center; padding: 20px;">
                            <h1 style="font-family: Arial, sans-serif; font-size: 24px; color: #333;">New Order</h1>
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            <p style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">Hello Admin,</p>
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" width="100%" style="margin-top: 20px;">
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333; padding: 10px; border-bottom: 1px solid #ddd;"><?php echo e($order->orderid); ?></td>
                                </tr>
                                <tr>
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333; padding: 10px; border-bottom: 1px solid #ddd;">Order Type:</td>
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333; padding: 10px; border-bottom: 1px solid #ddd;"><?php echo e($order->order_type); ?></td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333; padding: 10px; border-bottom: 1px solid #ddd;"><?php echo e($order->delivery_address); ?></td>
                                </tr>
                                <?php endif; ?>
                                <tr>
                                    ...
                                    <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333; padding: 10px; border-bottom: 1px solid #ddd; font-weight: bold">$<?php echo e(number_format($order->total_amount, 2)); ?></td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" width="100%" style="margin-top: 0px; text-align: left;">
                                <thead>
                                    ...
                                    <?php $__currentLoopData = $order->orderProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $orderProduct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd;"><?php echo e($orderProduct->product->title); ?></td>
                                            <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd;"><?php echo e($orderProduct->quantity); ?></td>
                                            <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd;"><?php echo e(formatAmount($orderProduct->price)); ?></td>
                                            <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd;"><?php echo e(formatAmount(($orderProduct->quantity*$orderProduct->price))); ?></td>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; font-weight: bold;"><?php echo e(formatAmount($order->subtotal_amount)); ?></td>
                                    </tr>

                                    <tr>
                                        <td colspan="3" style="font-family: Arial, sans-serif; font-size: 12px; font-weight: bold;  color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; text-align: right;">Tax (<?php echo e(applicationSettings('tax')); ?>%)		</td>
                                        <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; font-weight: bold;"><?php echo e(formatAmount($order->tax_amount)); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; font-weight: bold;"><?php echo e(formatAmount($order->delivery_charge)); ?></td>
                                    </tr>
                                    ...
                                    <tr>
                                        ...
                                        <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; font-weight: bold;"><?php echo e(formatAmount($order->coupon_discount)); ?></td>
                                    </tr>
                                    ...
                                    <?php if($order->royalty_points_amount): ?>
                                        <tr>
                                            ...
                                            <td style="font-family: Arial, sans-serif; font-size: 12px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; font-weight: bold;"><?php echo e(formatAmount($order->royalty_points_amount)); ?></td>
                                        </tr>
                                    <?php endif; ?>
                                    ...
                                    <tr>       
                                        ...
                                        <td style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; padding: 8px; border-bottom: 1px solid #dddddd; font-weight: bold;"><?php echo e(formatAmount($order->total_amount)); ?></td>
                                    </tr>
                                </thead>
                            </table>
...
<?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\emails\admin-order-placed.blade.php ENDPATH**/ ?>