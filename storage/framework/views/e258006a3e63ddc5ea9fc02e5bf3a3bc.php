                    ...
                    <tr>
                        <td style="text-align: center; padding: 20px;">
                            <h1 style="font-family: Arial, sans-serif; font-size: 24px; color: #980406;">Your request For 
                                Cancel Puja Request</h1>
                            <p
                                style="font-family: Arial, sans-serif; font-size: 13px; line-height: 20px; color: #000000;">
                                Dear <b> <?php echo e($hallOrder->user->first_name . ' ' . $hallOrder->user->last_name); ?>,
                                </b> <br/>
                                Your request for Cancelling the Puja Request has been successfully submitted. 
                                <br/>
                        ...
                        <td style="padding: 0 20px 20px 20px; ">
                                ...
                                <tr>
                                    <td>
                                        <p
                                            ...
                                            Request ID: <span
                                                style="color:#980406; font-weight: bold;"><?php echo e($hallOrder->puja_request_id); ?></span>
                                        </p>
                                    </td>
                                    <td align="right">
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" borderColor="#eeeeee" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->user->first_name . ' ' . $hallOrder->user->last_name); ?></td>
                                </tr>
                                <tr bgColor="#f1f1f1">
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->user->address); ?></td>
                                </tr>
                                <tr>
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" borderColor="#eeeeee" width="100%"
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e(formatDate($hallOrder->date_of_puja)); ?>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->time_of_puja); ?>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e(formatDate($hallOrder->alternate_date_of_puja1)); ?>
                                ...
                                <tr bgColor="#f1f1f1">
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->alternate_time_of_puja2); ?>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        <?php echo e($hallOrder->cancelled_comments); ?>
                            ...
                            <table cellpadding="0" cellspacing="0" border="1" borderColor="#eeeeee" width="100%" style="margin-top: 20px;">
                                <tr>
                                    <th style="font-family: Arial, sans-serif; font-size: 13px; line-height: 17px; color: #333333; padding: 5px; border-bottom: 1px solid #eeeeee;">
                                        Puja / Service - <?php echo e($hallOrder->puja_location == 'home' ? 'Home' : 'Temple'); ?>
...
</html><?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\emails\user_puja_cancel_mail.blade.php ENDPATH**/ ?>