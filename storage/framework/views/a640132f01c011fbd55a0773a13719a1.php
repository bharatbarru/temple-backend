                ...
                <table cellpadding="0" cellspacing="0" border="0" width="600" align="center" style="background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 4px 8px rgba(0,0,0,0.1); border-top: solid 10px #ea2735;">
                    ...
                    <tr>
                        <td style="padding: 20px;">
                            <p style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">Hello <?php echo e($order->customer ? $order->customer->name : $order->guest_name); ?>,</p>
...
<?php /**PATH C:\Users\PSHCPU008\Desktop\temple-backend\resources\views\emails\user-order-placed.blade.php ENDPATH**/ ?>